...
void
getCeasarInfo (char *type, int *key)
{
...
void
vigenereEncrypt (char *message, const char *key)
{
  int i = 0;
  int j = 0;
...
void
vigenereDecrypt (char *message, char *key)
{
  int i = 0;
  int j = 0;
  // iterate over the message
